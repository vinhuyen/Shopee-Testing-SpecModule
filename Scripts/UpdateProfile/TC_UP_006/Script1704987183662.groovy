...
WebUI.setText(findTestObject('Object Repository/UpdateProfile/input_phone'),'03622')

WebUI.click(findTestObject('Object Repository/UpdateProfile/button_save'))

WebUI.setText(findTestObject('Object Repository/UpdateProfile/input_phone'),'')
