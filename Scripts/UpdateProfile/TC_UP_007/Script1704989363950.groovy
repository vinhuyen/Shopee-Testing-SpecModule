...
WebUI.click(findTestObject('Object Repository/UpdateProfile/day_click'))

WebUI.click(findTestObject('Object Repository/UpdateProfile/month'))

WebUI.click(findTestObject('Object Repository/UpdateProfile/month_click'))

WebUI.click(findTestObject('Object Repository/UpdateProfile/year'))
WebUI.click(findTestObject('Object Repository/UpdateProfile/year_click'))
